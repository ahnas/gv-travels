                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center space-y-8">
                            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                                <span className="inline-block">They say it is complex.</span> <span className="inline-block text-red-600">We say not complicated.</span>
                            </h2>
                ...
                <section className="py-16 bg-muted/30">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="mt-12 text-center bg-primary/5 p-8 rounded-2xl max-w-3xl mx-auto">
                            ...
                            <Button
                                size="lg"
                                onClick={() => navigate('/contact?service=Visa Services')}
